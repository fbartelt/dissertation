...
The proposed vector field strategy was developed for any connected matrix Lie group. In this chatper, we define a path and EE-distance function specifically for a class of groups known as exponential Lie groups (see \cref{sec:background-exponential-map}), which are among the most common in engineering applications.
