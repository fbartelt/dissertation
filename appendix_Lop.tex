...
\begin{align}
    (\mathcal{L}_V f)_{\mathbf{G}} = \lim_{\varepsilon \to 0 }\frac{f\Bigl(\exp\bigl(\varepsilon\SL[\boldsymbol{\zeta}]\bigr)\mathbf{G}\Bigr) - f(\mathbf{G})}{\varepsilon},
\end{align}
